...
function ReferenceList() {
    const { referenceList, reference } = useSelector((state) => state.referenceData)
    ...
    useEffect(() => {
        dispatch(GetReferenceService(page, showNo, search))
    }, [page, showNo, search])
        ...
        <Box>
            <Box sx={{ display: "flex" }}>
                ...
                <Button
                    ...
                    startIcon={<AddIcon />}
                    onClick={() => router.push(`/admin/referlist/add`)}
                >
                    Refer Add
                </Button>
            </Box>
                ...
                <Table size="small" aria-label="simple table">
                    <TableHead sx={{ backgroundColor: "#00a65a" }}>
                        <TableRow>
                            ...
                            <TableCell style={rowText}>Refer Name</TableCell>
                    ...
                    <TableBody>
                        {referenceList && referenceList?.references?.map((row, i) => (
                            <TableRow
                                key={i}
                            ...
                            >
                                ...
                                >
                                    <button onClick={() => {
                                        router.push(`/admin/referlist/${row?._id}`)
                                    }}>
            ...
            >
                <Typography fontFamily={"Poppins"}>Showing 1-{showNo} of {referenceList?.pagination?.totalItems} entries</Typography>
                <br />
                <Pagination
                    size="large"
                    count={referenceList?.pagination?.totalPages}
                    page={page}
                    color="secondary"
