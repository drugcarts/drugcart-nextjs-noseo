...
function HerbsPage() {
    const { herbsList, herbs } = useSelector((state) => state.herbsData)
    ...
    useEffect(() => {
        dispatch(GetHerbsService(page, showNo, search))
    }, [page, showNo, search])
        ...
        <Box>
            <Box sx={{ display: "flex" }}>
                ...
                <Button
                    ...
                    startIcon={<AddIcon />}
                    onClick={() => router.push(`/admin/herbs/add`)}
                >
                    Add Herbs List
                </Button>
            </Box>
            ...
            <TableContainer component={Paper} sx={{ marginTop: 3 }}>
                <Table size="small" aria-label="simple table">
                    ...
                    <TableBody>
                        {herbsList && herbsList?.herbs_list?.map((row, i) => (
                            <TableRow
                                key={i}
                            ...
                            >
                                ...
                                >
                                    <button onClick={() => {
                                        router.push(`/admin/herbs/${row?._id}`)
                                    }}>
            ...
            >
                <Typography fontFamily={"Poppins"}>Showing 1-{showNo} of {herbsList?.pagination?.totalItems} entries</Typography>
                <br />
                <Pagination
                    size="large"
