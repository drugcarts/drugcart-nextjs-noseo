...
import { PutHerbsService, GetHerbsIdService } from '@/services/herbsService';
import { useDispatch, useSelector } from "react-redux";

function EditHerbs() {
    const { herbs } = useSelector((state) => state.herbsData)
    const router = useRouter();
    const dispatch = useDispatch()
    const params = useParams()

    useEffect(() => {
        dispatch(GetHerbsIdService(params?.id))
    }, [params?.id])
    ...
    const formik = useFormik({
        ...
        initialValues: {
            title: herbs?.title || "",
            url: herbs?.url || "",
            picture: herbs?.picture || "",
            alt: herbs?.alt || "",
            description: herbs?.description || "",
            languages: herbs?.languages || "",
            origin: herbs?.origin || "",
            composition: herbs?.composition || "",
            types: herbs?.types || "",
            infection: herbs?.infection || "",
            eydsorder: herbs?.eydsorder || "",
            hedsorder: herbs?.hedsorder || "",
            significance: herbs?.significance || "",
            dailylife: herbs?.dailylife || "",
            sideeffects: herbs?.sideeffects || "",
            compounds: herbs?.compounds || "",
            modernview: herbs?.modernview || "",
            dosage: herbs?.dosage || "",
            precautions: herbs?.precautions || "",
            contraindicate: herbs?.contraindicate || "",
            benefits: herbs?.benefits || "",
            faq: herbs?.faq || "",
            reference: herbs?.reference || "",
            metatitle: herbs?.metatitle || "",
            metakeyboard: herbs?.metakeyboard || "",
            metadesc: herbs?.metadesc || "",
            reviewsy: herbs?.reviewsy || "",
            writensy: herbs?.writensy || "",
            medicinal: herbs?.medicinal || "",
            treatment: herbs?.treatment || "",
        },
        ...
        onSubmit: async (data) => {
            console.log(data);
            await dispatch(PutHerbsService(herbs?._id, data))
        },
    });
