...
import { DeleteMainSliderService, GetMainSliderListService } from '@/services/mainSliderService';
...
function AdminMainSlider() {
    ...
    useEffect(() => {
        dispatch(GetMainSliderListService(page, showNo, search))
    }, [page, showNo, search])
        ...
        <Box>
            <Box sx={{ display: "flex" }}>
                ...
                <Button
                    ...
                    startIcon={<AddIcon />}
                    onClick={() => router.push(`/admin/mainslider/add`)}
                >
                    Add Main Slider
                </Button>
            </Box>
                ...
                <Table size="small" aria-label="simple table">
                    <TableHead sx={{ backgroundColor: "#00a65a" }}>
                        <TableRow>
                            ...
                            <TableCell style={rowText}>OrderNo</TableCell>
                            <TableCell style={rowText}>Slider Image</TableCell>
            ...
            >
                <Typography fontFamily={"Poppins"}>Showing 1-{showNo} of {mainSliderList?.pagination?.totalItems} entries</Typography>
                <br />
                <Pagination
                    size="large"
                    count={mainSliderList?.pagination?.totalPages}
                    page={page}
                    color="secondary"
