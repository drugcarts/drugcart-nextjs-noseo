...
const HealthDeviceProductAdd = () => {
    ...
    const health_store_FilterData = non_category?.categories?.filter((item) => item?.url === "health-care-device")
    ...
    console.log('non_category0', health_store_FilterData);
        ...
        <Box>
            <Box sx={{ display: "flex" }}>
                <Typography
                    ...
                    sx={{ flexGrow: 1 }}
                >
                    Add Health Care Device Product
                </Typography>
                <Button
                    color="success"
                    variant="contained"
...
export default HealthDeviceProductAdd;