...
const AyushProductAdd = () => {
  ...
  const categoryUrl = non_category?.categories?.map((item) => {
    return {
      key: item?.url,
  ...
  useEffect(() => {
    dispatch(GetNonCategoryService(1, 10, "ayush"))
...
// console.log('non_category0', formik.values.subcat_name);
...
export default AyushProductAdd;