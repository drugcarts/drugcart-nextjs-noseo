...
import { PostContractUserService } from '../../../../../services/contractUserService'
...
function ContractUserAdd() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (data, { resetForm }) => {
            await dispatch(PostContractUserService(data, resetForm));
        },
    });
...
export default ContractUserAdd;
